            ...
            >
              ...
              <Text
                className={`text-xs mt-1 ${
                  msg.sender === 'client' ? 'text-white/70' : 'text-[#64748B]'
                }`}
              >
                {msg.time}
              </Text>
      ...
      <View className="bg-white p-4 border-t border-[#E2E8F0]">
        <View className="flex items-center gap-2">
          <TextInput
            ...
            className="flex-1 px-4 py-3 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl
              focus:outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB]/10"
          />
          <TouchableOpacity
            className="w-12 h-12 bg-[#2563EB] text-white rounded-xl flex items-center justify-center
