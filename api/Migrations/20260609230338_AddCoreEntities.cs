        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProfessionalDescription = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    ...
                    CompletedServicesCount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApproximateLatitude = table.Column<double>(type: "double precision", nullable: true),
                    ApproximateLongitude = table.Column<double>(type: "double precision", nullable: true),
                    LocationReleased = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceAreas_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Conversations_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProviderId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProposedPrice = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProviderId = table.Column<Guid>(type: "uuid", nullable: false),
                    AppointmentStatus = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_Proposals_ProposalId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbacatePayPaymentId = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    WebhookEventType = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    ReportStatus = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Appointment_ProposalId",
                table: "Appointments",
                column: "ProposalId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UX_Appointment_ServiceId",
                table: "Appointments",
                column: "ServiceId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Conversation_ServiceId",
                table: "Conversations",
                column: "ServiceId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UX_Customer_UserId",
                table: "Customers",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UX_ProviderCategory_Provider_Category",
                table: "ProviderCategories",
                columns: new[] { "ProviderId", "CategoryId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UX_ServiceProvider_UserId",
                table: "Providers",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceAreas_ProviderId",
                table: "ServiceAreas",
                column: "ProviderId");
